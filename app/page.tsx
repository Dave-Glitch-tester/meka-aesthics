      ...
      <section className="relative h-[600px] w-full overflow-hidden">
        ...
        <div className="relative z-20 container mx-auto px-4 h-full flex flex-col justify-center">
          ...
          <p className="text-xl text-blue-50 max-w-xl mb-8">
            Discover our curated collection of elegant room decor that brings harmony and style to your home.
          </p>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-1/2">
              <h2 className="text-3xl font-bold text-blue-900 mb-6">About Meka Aesthetics</h2>
              <p className="text-blue-700 mb-4">
                Founded in 2022, Meka Aesthetics has been transforming living spaces with our thoughtfully designed home
                accessories and decor items.
              </p>
              <p className="text-blue-700 mb-6">
                We believe that your home should reflect your personality and style. Our collections are crafted to
                bring elegance, comfort, and a touch of luxury to every corner of your home.
              </p>
            ...
            <div className="md:w-1/2 relative h-[400px] rounded-lg overflow-hidden shadow-xl">
              <Image src="/placeholder.svg?height=800&width=800" alt="Our showroom" fill className="object-cover" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 relative">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-xl text-blue-100 max-w-2xl mx-auto mb-8">
            Join thousands of satisfied customers who have elevated their homes with our premium decor collections.
          </p>

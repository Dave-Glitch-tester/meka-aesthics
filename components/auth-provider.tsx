...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const login = async (email: string, password: string) => {
    try {
      // For demo purposes, we'll add some hardcoded users
      ...
      if (email === "admin@example.com" && password === "password") {
        ...
        // If we get here, try the API route as a fallback
        ...
        // For demo purposes, make the admin@example.com user an admin
